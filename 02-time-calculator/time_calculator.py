...
def add_time(start, duration, start_day=None):
    ...
    end_hours, end_minutes = _get_end_time_parts(start_hours, start_minutes, duration)
    ...
    end_day = _get_end_day(start_day, passed_days)
    end_day_period = _get_end_day_period(passed_periods, start_day_period)
    end_relative_part_suffix = _get_end_relative_part_suffix(passed_days)
...
def _get_end_time_parts(start_hours, start_minutes, duration):
...
def _get_end_day(start_day, passed_days):
...
def _get_end_day_period(passed_periods, start_day_period):
...
def _get_end_relative_part_suffix(passed_days):
    if passed_days == 0:
        return ''
